...
\begin{tikzpicture}[scale = 2, node distance = 2cm, auto]
    ...
    \node [right of=split_data] (foo) {};
    
    \node [block, right of=split_data, node distance=6cm] (apply_nn) {Apply NN};
